...
export const LibraryModal: React.FC<LibraryModalProps> = ({ isOpen, onClose, templates = [], setTemplates, onDeploy, capitalize }) => {
  ...
  // Fix: Only set pendingDeleteTemplate here
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-end bg-slate-900/10 backdrop-blur-md" onClick={onClose}>
        <div 
